...
{
    /// <inheritdoc />
    public partial class PagamentosEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiracao = table.Column<string>(type: "varchar(10)", nullable: false),
                    Cvv = table.Column<string>(type: "VARCHAR(4)", nullable: false),
                    DadosCartao_Id = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
